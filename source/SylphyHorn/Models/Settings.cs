...
namespace SylphyHorn.Models
{
	...
	public static class ShortcutSettings
	{
		...
		public static SerializableProperty<ShortcutKey?> Pin { get; }
			= new SerializableProperty<ShortcutKey?>(GetKey(), Providers.Local, new ShortcutKey(Key.P, Key.LeftCtrl, Key.LeftAlt, Key.LWin));

		public static SerializableProperty<ShortcutKey?> Unpin { get; }
			= new SerializableProperty<ShortcutKey?>(GetKey(), Providers.Local, new ShortcutKey(Key.P, Key.LeftCtrl, Key.LeftAlt, Key.LWin, Key.LeftShift));
